...
public class OneStopConnectionTest {
    @Rule
    ...
    @Test
    public void shouldFindJustOneStopRoute() {
    ...
    public static final String MODEL_STATEMENT =
            new StringBuilder()
                    ...
                    // Flight 3 departs just after Flight 1 arrives, so there is no time to make the connection
                    .append("CREATE (flight3:Flight {code:'UA-2', departs:1441119601, arrives:1441126800, distance:418})")
